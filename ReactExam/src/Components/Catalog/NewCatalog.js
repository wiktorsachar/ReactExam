                    ...
                    <div class="column-left">
                        ...
                        <div class="filter">
                            <div class="filter-header">
                                <h4>Search</h4>
                                <button onClick={()=>{a='';this.updateState();document.getElementById('searcher').value = ''}} class="clear" class="clear-button">Clear</button>
                            </div>
                            <div>
                                <input onChange={(y)=>{a=y.target.value;this.updateState()}} type="text" id="searcher" placeholder="search..."/>
                            </div>
                            {(() => {
                                let filtered = [];
